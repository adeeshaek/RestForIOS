#
#  Be sure to run `pod spec lint RestForIOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Adeesha Ekanayake" => "adeeshaekanayake@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Adeesha Ekanayake', 'other author'
  ...
  s.source       = { :git => "http://github.com/adeeshaek/RestForIOS.git", :tag => "v1.0" }
